...
\begin{document}
	...
	\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
		...
		Github:~~\href{https://github.com/ivanpuhachov/}{\texttt{[github.com/ivanpuhachov]}} & Last updated: October 2024\\
	\end{tabular*}
	...
	{\textbf{2D Animation Effects for 3D Graphics Pipelines}}
	{Work In Progress}
	{
		\underline{Ivan Puhachov}, Thibault Groueix, Noam Aigerman, Mikhail Bessmeltsev
		\newline
		\textbf{TLDR}: Using Stable Diffusion to generate expressive geometry-driven animation. Score Distillation Sampling (SDS), attention manipulation, Textual Inversion, LoRA.
	}
	{
	...
	}
	{
		...
		Fluid simulation using latent space of implicit geometric model.
	}
	{
	...
	{Montreal, Canada}
	{
		\vspace{-2mm}
		\begin{itemize}[leftmargin=*, topsep=0pt, partopsep=0pt, itemsep=0pt, parsep=0pt]
            \item SA 2023 paper: first-author publication, full R\&D cycle from idea generation to paper submission, data generation in Blender, computer vision model training and finetuning, optimization pipeline, user studies, numerical success metrics.
			\item SA 2024 paper: assisted in  project design, setting up experiments infrastructure.

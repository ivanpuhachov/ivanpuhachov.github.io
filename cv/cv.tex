...
\begin{document}
	...
	{\textbf{Generative 2D Graphics with Diffusion}}
	{Work In Progress}
	{
		\underline{Ivan Puhachov}, Thibault Groueix, Noam Aigerman, Mikhail Bessmeltsev
		\newline
		\textbf{TLDR}: Using Stable Diffusion to generate expressive geometry-driven animation. Score Distillation Sampling (SDS), attention manipulation, Textual Inversion.
	}
	{
	...
	{Montreal, Canada}
	{
		...
		\begin{itemize}[leftmargin=*, topsep=0pt, partopsep=0pt, itemsep=0pt, parsep=0pt]
			...
			\item Developed product demo for mesh deformation, skinning and rigging, machine learning for shape deformation.
        \end{itemize}
		\vspace{-4mm}
	}
	{Oct 2021 - Feb 2024}
